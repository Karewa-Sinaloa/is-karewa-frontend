		...
		<div class="content">
			...
			<main class="main">
				...
				>
					...
					<confirmation-popup
						:data="providerDeleteConfirmationData"
						@confirmed="providerDelete"
					...
					<div class="section__content">
						<Form
							@submit="onSubmit"
							class="form"
							:initial-values="myProvider"
							:validation-schema="providerValidateSchema"
							...
							<div>
								<div class="form__container form__container--full">
									...
									<Field
										id="name"
										name="name"
										placeholder="Nombre de de tu proveedor"
										class="form__input"
										:disabled="providerEditBlocked && myProvider.id"
										:class="{ 'form__input--disabled': providerEditBlocked && myProvider.id }"
									/>
									<ErrorMessage
										name="name"
										class="form__alert"
								...
								<div class="form__container form__container--full">
									...
									<Field
										...
										id="comments"
										name="comments"
										placeholder="Comentarios o notas acerca del proveedor"
										:disabled="providerEditBlocked && myProvider.id"
										:class="{ 'form__input--disabled': providerEditBlocked && myProvider.id }"
									/>
									<ErrorMessage
...
<script setup>
	...
	function manageRoute() {
		if (route.name === 'proveedoresView') {
			...
			myProvider.value = { name: '', rfc: '', comments: '', id: null };
		}
	}
